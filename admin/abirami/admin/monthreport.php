...
?>
                        ...
                        <div class="col-sm-12">
                            <div class="panel panel-bd lobidrag">
                                ...
                                <div class="panel-body">
                                        ...
                                        <input type="date" name="from" placeholder="Search in table" onchange="showr(this.value);">
                                        <input type="date" name="to" placeholder="Search in table">
 ...
 var to=$("input[name='to']").val();
  ...
  if (str == "") {
      ...
      xmlhttp.open("GET","mreport.php?d="+str+"to="+to,true);
      xmlhttp.send();
